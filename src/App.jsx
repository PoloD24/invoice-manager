...
const InvoiceManagerApp = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Map Modal (versión ligera con mapa estático) */}
      {showMapModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-[100]">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Search address in USA</label>
                ...
                <p className="text-xs text-gray-500 mt-2">Press Enter or click search to find location</p>
              </div>
              ...
              {selectedLocation && (
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <img
                      src={`https://staticmap.openstreetmap.de/staticmap.php?center=${selectedLocation.lat},${selectedLocation.lng}&zoom=15&size=600x300&markers=${selectedLocation.lat},${selectedLocation.lng},red`}
                      alt="Location preview"
                      className="w-full h-48 object-cover rounded border"
                      onError={(e) => {
                        // Fallback a otro servicio estático
                        e.target.src = `https://www.mapquestapi.com/staticmap/v5/map?center=${selectedLocation.lat},${selectedLocation.lng}&size=600,300&key=YOUR_KEY`;
                        e.target.style.display = 'none';
                        e.target.parentElement.innerHTML = '<div class="w-full h-48 flex items-center justify-center bg-gray-100 text-gray-500 text-sm">Map preview not available</div>';
                      }}
                    />
                  </div>
                </div>
